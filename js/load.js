...
let lamps = [{ x: 20, y: 0.67 * parseInt(canvas.height), h: 0.15 * parseInt(canvas.height), w: 0.07 * parseInt(canvas.height) * 1 }, { x: 160, y: 0.67 * parseInt(canvas.height), h: 0.15 * parseInt(canvas.height), w: 0.07 * parseInt(canvas.height) * 1 }];
