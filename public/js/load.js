...
let nvhs = [];
let shavars = [{ x: Math.round(0.5 * canvas.width + 0.5 * canvas.width * Math.random()), y: 0.85 * parseInt(canvas.height), h: 0.07 * parseInt(canvas.height), w: 0.12 * parseInt(canvas.height) * 1 }];
