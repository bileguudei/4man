...
let boy = { x: 100, y: 0.65 * parseInt(canvas.height), height: 0.15 * parseInt(canvas.height), width: 0.25 * parseInt(canvas.height) * 1 };
...
let dogs = [{ x: 1550, y: 0.8 * parseInt(canvas.height), h: 0.1 * parseInt(canvas.height), w: 0.1 * parseInt(canvas.height) * 1 }];
let nvhs = [{ x: Math.round(1.5 * canvas.width + canvas.width * Math.random()), y: 0.86 * parseInt(canvas.height), h: 0.05 * parseInt(canvas.height), w: 0.1 * parseInt(canvas.height) * 1 }];
let shavars = [{ x: 0.5 * canvas.width + Math.round(0.5 * canvas.width * Math.random()), y: 0.85 * parseInt(canvas.height), h: 0.07 * parseInt(canvas.height), w: 0.12 * parseInt(canvas.height) * 1 }];
